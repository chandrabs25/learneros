...
def main():
    ...
    new_exercises = [
        ...
        {"number": 24, "problem": "Describe the following: (i) Acetylation (ii) Cannizzaro reaction (iii) Cross aldol condensation (iv) Decarboxylation", "solution": None, "difficulty": "easy", "exercise_type": "conceptual", "tests_concepts": ["concept:named_reactions"]}
    ]
