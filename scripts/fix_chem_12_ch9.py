...
def main():
    ...
    new_exercises = [
        {"number": 15, "problem": "An aromatic compound 'A' on treatment with aqueous ammonia and heating forms compound 'B' which on heating with $Br_2$ and KOH forms a compound 'C' of molecular formula $C_6H_7N$. Write the structures and IUPAC names of compounds A, B and C.", "solution": None, "difficulty": "hard", "exercise_type": "application", "tests": ["concept:hofmann_degradation", "concept:identification"]},
        {"number": 16, "problem": "Complete the following reactions: (i) $C_6H_5NH_2 + CHCl_3 + alc. KOH \\rightarrow$ (ii) $C_6H_5N_2Cl + H_3PO_2 + H_2O \\rightarrow$ (iii) $C_6H_5NH_2 + H_2SO_4 (conc.) \\rightarrow$ (iv) $C_6H_5N_2Cl + C_2H_5OH \\rightarrow$ (v) $C_6H_5NH_2 + Br_2 (aq) \\rightarrow$ (vi) $C_6H_5NH_2 + (CH_3CO)_2O \\rightarrow$ (vii) $C_6H_5N_2Cl \\xrightarrow{HBF_4, then NaNO_2/Cu}$", "solution": None, "difficulty": "medium", "exercise_type": "application", "tests": ["concept:reactions_of_amines", "concept:diazonium_reactions"]},
        {"number": 17, "problem": "Why cannot aromatic primary amines be prepared by Gabriel phthalimide synthesis?", "solution": None, "difficulty": "medium", "exercise_type": "conceptual", "tests": ["concept:gabriel_synthesis"]},
        {"number": 18, "problem": "Write the reactions of (i) aromatic and (ii) aliphatic primary amines with nitrous acid.", "solution": None, "difficulty": "medium", "exercise_type": "application", "tests": ["concept:reactions_with_nitrous_acid"]},
        {"number": 19, "problem": "Give plausible explanation for each of the following: (i) Why are amines less acidic than alcohols of comparable molecular masses? (ii) Why do primary amines have higher boiling point than tertiary amines? (iii) Why are aliphatic amines stronger bases than aromatic amines?", "solution": None, "difficulty": "medium", "exercise_type": "conceptual", "tests": ["concept:basicity_of_amines", "concept:physical_properties"]}
    ]
