...
def main():
    ...
    # =========================================================================
    new_exercises = [
        {"number": 7, "problem": "Name the following halides according to IUPAC system and classify them as alkyl, allyl, benzyl (primary, secondary, tertiary), vinyl or aryl halides: (i) $(CH_3)_2CHCH(Cl)CH_3$ (ii) $CH_3CH_2C(CH_3)_2CH_2I$ (iii) $CH_3CH(CH_3)CH(Br)CH_3$ (iv) $CH_3C(Cl)(C_2H_5)CH_2CH_3$ (v) $CH_3CH=CHC(Br)(CH_3)_2$ (vi) $m$-$ClCH_2C_6H_4CH_2C(CH_3)_3$ (vii) $p$-$ClC_6H_4CH_2CH(CH_3)_2$ (viii) $o$-$Br$-$C_6H_4CH(CH_3)CH_2CH_3$", "solution": None, "difficulty": "medium", "exercise_type": "conceptual", "tests_concepts": ["concept:iupac_nomenclature", "concept:classification_of_halides"]},
        {"number": 8, "problem": "Give the IUPAC names of the following compounds: (i) $CH_3CH(Cl)CH(Br)CH_3$ (ii) $CHF_2CBrClF$ (iii) $ClCH_2C \\equiv CCH_2Br$ (iv) $(CCl_3)_3CCl$ (v) $CH_3C(p$-$ClC_6H_4)_2CH(Br)CH_3$ (vi) $(CH_3)_3CCH=CClC_6H_4I$-$p$", "solution": None, "difficulty": "medium", "exercise_type": "conceptual", "tests_concepts": ["concept:iupac_nomenclature"]},
        {"number": 9, "problem": "Write the structures of the following organic halogen compounds: (i) 2-Chloro-3-methylpentane (ii) 1-Chloro-4-ethylcyclohexane (iii) 1-Bromo-4-sec-butyl-2-methylbenzene (iv) 1,4-Dibromobut-2-ene", "solution": None, "difficulty": "easy", "exercise_type": "application", "tests_concepts": ["concept:structural_formulas"]},
        {"number": 10, "problem": "Which one of the following has the highest dipole moment? (i) $CH_2Cl_2$ (ii) $CHCl_3$ (iii) $CCl_4$", "solution": None, "difficulty": "easy", "exercise_type": "conceptual", "tests_concepts": ["concept:dipole_moment"]},
        {"number": 11, "problem": "A hydrocarbon $C_5H_{10}$ does not react with chlorine in dark but gives a single monochloro compound $C_5H_9Cl$ in bright sunlight. Identify the hydrocarbon.", "solution": None, "difficulty": "medium", "exercise_type": "conceptual", "tests_concepts": ["concept:free_radical_halogenation"]},
        {"number": 12, "problem": "Write the isomers of the compound having formula $C_4H_9Br$.", "solution": None, "difficulty": "easy", "exercise_type": "application", "tests_concepts": ["concept:structural_isomerism"]},
        {"number": 13, "problem": "Write the equations for the preparation of 1-iodobutane from (i) 1-butanol (ii) 1-chlorobutane (iii) but-1-ene.", "solution": None, "difficulty": "medium", "exercise_type": "application", "tests_concepts": ["concept:preparation_of_haloalkanes"]},
        {"number": 14, "problem": "What are ambident nucleophiles? Explain with an example.", "solution": None, "difficulty": "easy", "exercise_type": "conceptual", "tests_concepts": ["concept:ambident_nucleophiles"]},
        {"number": 15, "problem": "Which compound in each of the following pairs will react faster in $S_N2$ reaction with $OH^-$? (i) $CH_3Br$ or $CH_3I$ (ii) $(CH_3)_3CCl$ or $CH_3Cl$", "solution": None, "difficulty": "medium", "exercise_type": "conceptual", "tests_concepts": ["concept:sn2_reaction"]},
        {"number": 16, "problem": "Predict all the alkenes that would be formed by dehydrohalogenation of the following halides with sodium ethoxide in ethanol and identify the major alkene: (i) 1-Bromo-1-methylcyclohexane (ii) 2-Chloro-2-methylbutane (iii) 2,2,3-Trimethyl-3-bromopentane.", "solution": None, "difficulty": "hard", "exercise_type": "application", "tests_concepts": ["concept:elimination_reactions", "concept:zaitsev_rule"]},
        {"number": 17, "problem": "How will you bring about the following conversions? (i) Ethanol to but-1-yne (ii) Ethane to bromoethene (iii) Propene to 1-nitropropane (iv) Toluene to benzyl alcohol (v) Propene to propyne (vi) Ethanol to ethyl fluoride (vii) Bromomethane to propanone (viii) But-1-ene to but-2-ene (ix) 1-Chlorobutane to n-octane (x) Benzene to biphenyl.", "solution": None, "difficulty": "hard", "exercise_type": "application", "tests_concepts": ["concept:organic_conversions"]},
        {"number": 18, "problem": "Explain why (i) the dipole moment of chlorobenzene is lower than that of cyclohexyl chloride? (ii) alkyl halides, though polar, are immiscible with water? (iii) Grignard reagents should be prepared under anhydrous conditions?", "solution": None, "difficulty": "medium", "exercise_type": "conceptual", "tests_concepts": ["concept:dipole_moment", "concept:grignard_reagent"]},
        {"number": 19, "problem": "Give the uses of freon 12, DDT, carbon tetrachloride and iodoform.", "solution": None, "difficulty": "easy", "exercise_type": "conceptual", "tests_concepts": ["concept:polyhalogen_compounds"]},
        {"number": 20, "problem": "Write the structure of the major organic product in each of the following reactions: (i) $CH_3CH_2CH_2Cl + NaI \\xrightarrow{acetone}$ (ii) $(CH_3)_3CBr + KOH \\xrightarrow{ethanol}$ (iii) $CH_3CH(Br)CH_2CH_3 + NaOH \\xrightarrow{water}$ (iv) $CH_3CH_2Br + KCN \\rightarrow$ (v) $C_6H_5ONa + C_2H_5Cl \\rightarrow$ (vi) $CH_3CH_2CH_2OH + SOCl_2 \\rightarrow$ (vii) $CH_3CH_2CH=CH_2 + HBr \\rightarrow$ (viii) $CH_3CH=C(CH_3)_2 + HBr \\rightarrow$", "solution": None, "difficulty": "hard", "exercise_type": "application", "tests_concepts": ["concept:nucleophilic_substitution", "concept:elimination_reactions"]},
        {"number": 21, "problem": "Write the mechanism of the following reaction: $nBuBr + KCN \\xrightarrow{EtOH-H_2O} nBuCN$", "solution": None, "difficulty": "medium", "exercise_type": "application", "tests_concepts": ["concept:sn2_reaction"]},
        {"number": 22, "problem": "Arrange the compounds of each set in order of reactivity towards $S_N2$ displacement: (i) 2-Bromo-2-methylbutane, 1-Bromopentane, 2-Bromopentane (ii) 1-Bromo-3-methylbutane, 2-Bromo-2-methylbutane, 2-Bromo-3-methylbutane (iii) 1-Bromobutane, 1-Bromo-2,2-dimethylpropane, 1-Bromo-2-methylbutane, 1-Bromo-3-methylbutane.", "solution": None, "difficulty": "medium", "exercise_type": "conceptual", "tests_concepts": ["concept:sn2_reaction", "concept:steric_hindrance"]},
        {"number": 23, "problem": "Out of $C_6H_5CH_2Cl$ and $C_6H_5CHClC_6H_5$, which is more easily hydrolysed by aqueous KOH?", "solution": None, "difficulty": "medium", "exercise_type": "conceptual", "tests_concepts": ["concept:nucleophilic_substitution"]},
        {"number": 24, "problem": "p-Dichlorobenzene has higher m.p. than those of o- and m-isomers. Discuss.", "solution": None, "difficulty": "medium", "exercise_type": "conceptual", "tests_concepts": ["concept:physical_properties_of_haloarenes"]},
        ...
        {"number": 26, "problem": "The treatment of alkyl chlorides with aqueous KOH leads to the formation of alcohols but in the presence of alcoholic KOH, alkenes are major products. Explain.", "solution": None, "difficulty": "medium", "exercise_type": "conceptual", "tests_concepts": ["concept:substitution_vs_elimination"]},
        {"number": 27, "problem": "Primary alkyl halide $C_4H_9Br$ (a) reacted with alcoholic KOH to give compound (b). Compound (b) is reacted with HBr to give (c) which is an isomer of (a). When (a) is reacted with sodium metal it gives compound (d), $C_8H_{18}$, which is different from the compound formed when n-butyl bromide is reacted with sodium. Give the structural formula of (a) and write the equations for all the reactions.", "solution": None, "difficulty": "hard", "exercise_type": "application", "tests_concepts": ["concept:elimination_reactions", "concept:wurtz_reaction"]},
        {"number": 28, "problem": "What happens when (i) n-butyl chloride is treated with alcoholic KOH, (ii) bromobenzene is treated with Mg in the presence of dry ether, (iii) chlorobenzene is subjected to hydrolysis, (iv) ethyl chloride is treated with aqueous KOH, (v) methyl bromide is treated with sodium in the presence of dry ether, (vi) methyl chloride is treated with KCN?", "solution": None, "difficulty": "medium", "exercise_type": "application", "tests_concepts": ["concept:reactions_of_haloalkanes"]}
    ]
