...
function HeaderInner() {
    ...
    const isRoleKnownForNav = !loading;
            ...
            <div className="header-left">
                <Link href={homeHref} className="logo-box">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 2L22 22H2L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M7 12H17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                </Link>
                <h2 className="header-title">LearnerOS</h2>
            </div>
