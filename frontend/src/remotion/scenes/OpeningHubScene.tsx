...
export const OpeningHubScene = () => {
  ...
  const selectedIndex = frame >= 1.2 * fps ? 2 : currentIndex;
  const pressProgress = interpolate(frame, [1.45 * fps, 1.7 * fps, 1.95 * fps], [0, 1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    ...
    >
      ...
      >
        {cards.map((card, i) => {
          ...
          const cardOpacity = interpolate(normalizedDistance, [0, 1], [1, 0.62]);
          ...
          return (
            <div
              ...
              style={{
                ...
                opacity: cardOpacity,
                filter:
                  isActive || i === 1 ? "grayscale(0%)" : `grayscale(${normalizedDistance})`,
              }}
            >
              <div
                style={{
